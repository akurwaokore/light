    ...
    <header className="sticky top-0 z-50 flex h-16 items-center gap-4 border-b border-border bg-background px-6">
      ...
      <div className="flex-1 flex items-center gap-4">
        <div className="relative max-w-md flex-1 ml-4">
          ...
          <Input placeholder="Search members, events, posts..." className="pl-10" />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="text-destructive cursor-pointer" onClick={() => window.location.href = '/api/auth/signout'}>
