...
function SignUpForm() {
  ...
  const onSubmit = async (data: SignUpForm) => {
    ...
    try {
      ...
      const { data: signUpData, error: signUpError } = await supabase.auth.signUp({
        ...
        options: {
          ...
          data: {
            ...
            graduation_year: data.graduationYear ? Number.parseInt(data.graduationYear) : null,
      ...
      console.error("[akurwas] Signup error:", err)
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-muted/30 p-4 py-8">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Create your Light Alumni account</CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => setValue("campus", value)} disabled={isLoading || isGoogleLoading}>
                  <SelectTrigger>
